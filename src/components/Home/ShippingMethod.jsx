...
const ShippingMethod = ({ navigation }) => {
	return (
		<View style={styles.container}>
			<TouchableOpacity onPress={() => navigation.navigate("shipseller")}>
				...
				/>
				<Text style={{ marginLeft: 65, marginTop: -30 }}>
					Your order will be handled completely by the seller from {"\n"}payment
					to delivery. Contact seller for delivery information
				</Text>
			</TouchableOpacity>
			...
			<Octicons
				...
				style={{ marginLeft: 30, marginTop: 20 }}
			/>
			<Text style={{ marginLeft: 65, marginTop: -20 }}>
			...
			>
				<Text style={{ marginLeft: 15, marginTop: 10 }}>N500</Text>
			</View>
		</View>
	);
};
